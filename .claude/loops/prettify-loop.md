...
The design targets are the first-party artboards in `design/references/artboard-*.png`
(rendered from `design/canvas/index.html`); `ux-critic` scores against them and
`design/rubric.md`.
